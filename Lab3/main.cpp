...
const char diceTexFile[] = "images/dice.jpg";
...
void MakeReflectionImage( void )
{
    ...
    gluLookAt(eyePos[0], eyePos[1], 2 * TABLETOP_Z - eyePos[2],
            eyePos[0], eyePos[1], eyePos[2], 1, 0, 0);
...
// This texture object is for the dice texture map.

    glGenTextures( 1, &diceTexObj );
    glBindTexture(GL_TEXTURE_2D, diceTexObj );
    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT );
    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT );
    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR );
    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR );

    if ( ReadImageFile(diceTexFile, &imageData,
                       &imageWidth, &imageHeight, &numComponents ) == 0 ) exit( 1 );
...
void DrawDice( void )
{
    ...
    float size = 0.4;
    glPushMatrix();
    glTranslated( 1.8 * size, -1.5 * size, 0.6 * size + TABLETOP_Z );

    glNormal3f( 0.0, 1.0, 0.0 );
    SubdivideAndDrawQuad( 24, 24, 0.5, 0.25, size / 2, size / 2, 0,
                                  0.75, 0.25, size / 2, size / 2, size,
                                  0.75, 0.5, -size / 2, size / 2, size,
                                  0.5, 0.5, -size / 2, size / 2, 0);
    glNormal3f( 0.0, -1.0, 0.0 );
    SubdivideAndDrawQuad( 24, 24, 0.25, 0.25, size / 2, -size / 2, 0,
                                  0.25, 0.5, -size / 2, -size / 2, 0,
                                  0, 0.5, -size / 2, -size / 2, size,
                                  0, 0.25, size / 2, -size / 2, size);
    glNormal3f( 1.0, 0.0, 0.0 );
    SubdivideAndDrawQuad( 24, 24, 0.75, 0.25, size / 2, size / 2, 0,
                                  0.5, 0.25, size / 2, -size / 2, 0,
                                  0.5, 0.0, size / 2, -size / 2, size,
                                  0.75, 0.0, size / 2, size / 2, size);
    glNormal3f( -1.0, 0.0, 0.0 );
    SubdivideAndDrawQuad( 24, 24, 0.75, 0.5, -size / 2, size / 2, 0,
                                  0.75, 0.75, -size / 2, size / 2, size,
                                  0.5, 0.75, -size / 2, -size / 2, size,
                                  0.5, 0.5, -size / 2, -size / 2, 0);
    glNormal3f( 0.0, 0.0, 1.0 );
    SubdivideAndDrawQuad( 24, 24, 0.75, 0.25, size / 2, size / 2, size,
                                  1.0, 0.25, -size / 2, size / 2, size,
                                  1.0, 0.5, -size / 2, -size / 2, size,
                                  0.75, 0.5, size / 2, -size / 2, size);
    glNormal3f( 0.0, 0.0, -1.0 );
    SubdivideAndDrawQuad( 24, 24, 0.5, 0.25, size / 2, size / 2, 0,
                                  0.5, 0.5, -size / 2, size / 2, 0,
                                  0.25, 0.5, -size / 2, -size / 2, 0,
                                  0.25, 0.25, size / 2, -size / 2, 0);
