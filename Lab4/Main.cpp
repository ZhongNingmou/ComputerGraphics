...
// Define materials.
    ...
    // Insert into scene materials vector.
    scene.materials = { lightRed, lightGreen, lightBlue, gray };
...
// Define point light sources.
   ...
   scene.ptLights.resize(2);
    ...
    PointLightSource light0 = { Vector3d(150.0, 120.0, 35.0), Color(1.0f, 1.0f, 1.0f) * 0.5f };
    PointLightSource light1 = { Vector3d(35.0, 120.0, 150.0), Color(1.0f, 1.0f, 1.0f) * 0.5f };

    scene.ptLights = { light0, light1 };

// Define surface primitives.

    scene.surfaces.resize(14);

    auto horzPlane = new Plane( 0.0, 1.0, 0.0, 0.0, scene.materials[3] ); // Horizontal plane.
    auto leftVertPlane = new Plane( 1.0, 0.0, 0.0, 0.0, scene.materials[0] ); // Left vertical plane.
    auto rightVertPlane = new Plane( 0.0, 0.0, 1.0, 0.0, scene.materials[1] ); // Right vertical plane.
    auto Sphere1 =  new Sphere( Vector3d( 45.0, 15.0, 85.0 ), 15.0, scene.materials[0] ); 
    auto Sphere2 = new Sphere( Vector3d( 85.0, 15.0, 45.0 ), 15.0, scene.materials[1] ); 
    auto Sphere3 = new Sphere( Vector3d( 32.25, 35.75, 32.25 ), 5.0, scene.materials[3] ); 
    auto Sphere4 = new Sphere( Vector3d( 15.0, 2.5, 15.0 ), 5.0, scene.materials[3] ); 
    auto Sphere5 = new Sphere( Vector3d( 50.0, 2.5, 50.0 ), 5.0, scene.materials[3] ); 
    auto Sphere6 = new Sphere( Vector3d( 50, 2.5, 15.0 ), 5.0, scene.materials[3] ); 
    auto Sphere7 = new Sphere( Vector3d( 15.0, 2.5, 50.0 ), 5.0, scene.materials[3] ); 

    auto pyramidNegZ = new Triangle( Vector3d( 15.0, 5.0, 15.0 ),
                                      Vector3d( 32.25, 30.75, 32.25 ),
                                      Vector3d( 50.0, 5.0, 15.0 ),
                                      scene.materials[2]);

    auto pyramidPosX1 = new Triangle( Vector3d( 50.0, 5.0, 15.0 ),
                                      Vector3d( 32.25, 30.75, 32.25),
                                      Vector3d( 50.0, 5.0, 50.0 ),
                                      scene.materials[2] );

    auto pyramidPosZ = new Triangle( Vector3d( 50.0, 5.0, 50.0 ),
                                      Vector3d( 32.25, 30.75, 32.25 ),
                                      Vector3d( 15.0, 5.0, 50.0 ),
                                      scene.materials[2]);

    auto pyramidPosX2 = new Triangle( Vector3d( 15.0, 5.0, 50.0 ),
                                      Vector3d( 32.25, 30.75, 32.25 ),
    ...
    scene.surfaces = { horzPlane, leftVertPlane, rightVertPlane, 
                       ...
                       pyramidNegZ, pyramidPosX1,
                       pyramidPosZ, pyramidPosX2 };

// Define camera.

    scene.camera = Camera( Vector3d( 150.0, 25.0, 150.0 ), 
                           Vector3d( 37.5, 25, 37.5 ), 
